  ...
  name: 'ContentMall',
	...
	methods: {
      ...
      uploadFiles: "upload/uploadFiles",
		...
		getContent(code) {
			...
			let payload = {
				method: "get",
				url: `emall/getContent?kategori=mall&id_kategori_content=${code}`,
		...
		bukaDialog(item, index){
			...
			if(index == 0){
				...
				this.inputContent.UnixText = item.UnixText ? item.UnixText : ''
				this.inputContent.id_content_mall = item.idContentMall ? item.idContentMall : ''
				this.inputContent.id_mall = item.idMall ? item.idMall : ''
    ...
    HapusRecord(item) {
      let bodyData = {
        jenis: 'DELETE',
				content: 'Mall',
        id_content_mall: item.idContentMall,
