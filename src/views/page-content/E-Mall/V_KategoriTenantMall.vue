...
export default {
  name: 'KategoriTenantMall',
    ...
    query: {
      ...
      { text: "Kategori", value: "kategori_tenant", sortable: false },
	...
	methods: {
		...
		getKategoriTenantMall() {
			...
			let payload = {
				method: "get",
				url: `moduleMain/getAllKategoriTenantMall`,
		...
		bukaDialog(item, index){
			...
			if(index == 0){
				...
				this.inputKategoriTenantMall.id_kategori_tenant = item.id_kategori_tenant
        this.inputKategoriTenantMall.kategori_tenant = item.kategori_tenant
			}
      ...
      let payload = {
				method: "post",
				url: `moduleMain/prosesKategoriTenantMall`,
        body: bodyData,
				authToken: localStorage.getItem('user_token')
			};
			this.fetchData(payload)
    ...
    HapusRecord(item) {
      let bodyData = {
        jenis: 'DELETE',
        id_kategori_tenant: item.id_kategori_tenant,
        kategori_tenant: item.kategori_tenant,
